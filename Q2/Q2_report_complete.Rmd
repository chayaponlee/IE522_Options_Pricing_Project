...
\textbf{2.6 Variance Reduction Techniques-- Moment Matching}
...
knitr::kable(moment_matching_results, caption = "Moment Matching Simulation Results")
```
...
ggplot(moment_matching_results, aes(x = Sample_Size, y = Option_Price)) +
  ...
  scale_x_log10() +
  labs(
    title = "Convergence of Option Price with Increasing Sample Size",
    x = "Sample Size (log scale)",
    y = "Option Price"
  ) +
  theme_minimal()
...
ggplot(moment_matching_results, aes(x = Sample_Size, y = Standard_Error)) +
  ...
  scale_y_log10() +
  labs(
    title = "Convergence of Standard Error with Increasing Sample Size",
    x = "Sample Size (log scale)",
    y = "Standard Error (log scale)"
  ) +
  theme_minimal()
...
ggplot(moment_matching_results, aes(x = Sample_Size, y = Computation_Time_sec)) +
  ...
  scale_x_log10() +
  labs(
    title = "Computation Time with Increasing Sample Size",
    x = "Sample Size (log scale)",
    y = "Computation Time (seconds)"
  ) +
  theme_minimal()
